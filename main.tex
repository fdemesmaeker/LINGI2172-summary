...
%                                                    7th edition    
% S1 Introduction							    		1+2         (Thomas)
% S5 SQL							    			    6			(Aurélien)			
% S6 Constraints and Updating							6           (Aurélien)
% S7 Database Design: Normal Forms 			            14+15       (Romain)
% S9 Database Design: ER and transfo rules			    3+4         (Guillaume + Thomas)
% S9 Views, Triggers, Database Programming				7           (Aurélien)
% S10 Transactions							            20          (Florian) --> Done
% S11 Concurrency Control & Recovery					21+22       (Victor + Florian) --> Done
% S12 Disk & Indexing									16+17       (Flo 16, Guillaume 17)
% S13 Query Planning & Optimization						18+19       (Guillaume 18, Thomas 19)
